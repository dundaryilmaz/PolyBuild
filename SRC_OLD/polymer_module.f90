...
&           new_chain%mer_flag(1))
  ...
  !================================================================================================
  function create_chain(n_mers,nth_chain,xmers, surf_type,head_pos,success) result (new_chain)
    type(chain) :: new_chain
    integer :: nth_chain
    integer :: n_mers,i,p,n_beads,nxmers,xpoint
...
200   vec=random_unit_vec()
      vec=vec*base_mer%mer_length*0.7d0
...
!       print*,'Distance: ', dist, 'bead :' ,i
     ...
     !      print*,' dist 1 ', dist
          ...
          if( dist < mer_width .and. i .ne. n_beads/2 ) then !cos(15)§
            folded=.TRUE.
     !      print*,' dist 2 ' , i,dist
          end if
        end if
