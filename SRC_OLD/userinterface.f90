...
integer :: n_def_groups,n_cross_links
...
n_chains=n_cont_chains+n_amorph_chains+nfunctional+n_xlink_chains
...
if(allocated(blocks))then
 ...
 iostat=connection_table(outputfilename)
